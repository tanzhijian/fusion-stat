...
class TestCompetition:
    ...
    def spider(self) -> official.competition.LaLigaSpider:
        return official.competition.LaLigaSpider(name="La Liga", season=2023)

    def test_request(self, spider: official.competition.LaLigaSpider) -> None:
        assert (
            spider.request.url
        ...
        com_2013 = official.competition.LaLigaSpider(
            name="La Liga", season=2013
        )
        assert (
    ...
    def test_parse(self, spider: official.competition.LaLigaSpider) -> None:
        data = read_data(
